...
const DeveloperActivity: React.FC = () => {
  ...
  return (
    <div className="p-4 bg-theme-bg rounded-lg text-theme-text-primary">
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 gap-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
            ...
            <div className="bg-theme-accent/10 p-3 rounded">
              <div className="text-xs text-theme-text-secondary">Forks</div>
              <div className="text-lg font-semibold">{formatNumber(devData.forks)}</div>
            </div>
            <div className="bg-theme-accent/10 p-3 rounded">
            ...
            <div className="bg-theme-accent/10 p-3 rounded">
              ...
              <div className="text-lg font-semibold">
                {formatNumber(devData.commit_count_4_weeks)}
              </div>
            </div>
          </div>
